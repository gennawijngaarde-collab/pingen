...
const fr: Dictionary = {
  ...
  schedule: {
    ...
    close: 'Fermer',
    errorTitle: 'Erreur',
    pinDeleted: 'Pin supprimé',
    deleteFailed: 'Impossible de supprimer le pin',
    scheduleCancelled: 'Planification annulée',
    cancelFailed: "Impossible d'annuler la planification",
    pinScheduled: 'Pin planifié',
    pinRescheduled: 'Pin replanifié',
    publishOn: 'Publication le {date}',
    rescheduleFailed: 'Impossible de replanifier le pin',
    copyFailed: 'Impossible de copier',
    titleRequired: 'Titre requis',
    titleEmpty: 'Le titre ne peut pas être vide.',
    pinUpdated: 'Pin modifié',
    updateFailed: 'Impossible de modifier le pin',
    deleteConfirm: 'Êtes-vous sûr de vouloir supprimer ce pin ?',
  },
  publish: {
    publish: 'Publier',
    publishNow: 'Publier maintenant',
    publishAll: 'Tout publier maintenant',
    publishAllConfirm:
      'Publier maintenant TOUS les pins programmés sur Pinterest, y compris ceux prévus plus tard ?',
    publishing: 'Publication…',
    nothingToPublish: 'Aucun pin à publier',
    nothingToPublishDesc: 'Aucun pin programmé ne correspond à cette action.',
    publishedOne: 'Pin publié sur Pinterest !',
    publishedMany: '{count} pins publiés sur Pinterest !',
    partialFailure: '{ok} publié(s), {ko} échec(s)',
    publishFailed: 'Publication impossible',
    publishError: 'Erreur de publication',
    cannotPublish: 'Impossible de publier le pin',
    sessionExpired: 'Session expirée, reconnecte-toi.',
    awaitingAccessTitle: "{count} pin(s) en attente d'approbation Pinterest",
    awaitingAccessBody:
      "Ton application Pinterest est en accès « Trial » : Pinterest n'autorise pas encore la publication réelle. Demande l'accès « Standard » depuis ton espace développeur ; tes pins planifiés seront publiés automatiquement dès l'approbation, sans rien refaire.",
    awaitingAccessPin:
      "En attente d'approbation Pinterest (accès « Trial »). Ce pin sera publié automatiquement dès l'approbation.",
    awaitingAccessShort: "{count} pin(s) en attente d'approbation Pinterest.",
    openPinterestDev: 'Ouvrir developers.pinterest.com',
    readyToPublish: '{count} pin(s) prêt(s) à publier',
    readyToPublishDesc: 'Ces pins sont planifiés pour maintenant ou avant.',
    autoPublishing: 'Publication automatique en cours…',
    autoPublishFailed: 'Publication automatique en échec',
    someFailed: "{count} pin(s) n'ont pas pu être publiés.",
  },
  hero: {
